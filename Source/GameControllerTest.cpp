...
void GameControllerTest::registerControllerListener()
{
    ...
    gameControllerListener->onConnected = AX_CALLBACK_2(GameControllerTest::onConnectController,this);
    gameControllerListener->onDisconnected = AX_CALLBACK_2(GameControllerTest::onDisconnectedController,this);
    gameControllerListener->onKeyDown = AX_CALLBACK_3(GameControllerTest::onKeyDown, this);
    gameControllerListener->onKeyUp = AX_CALLBACK_3(GameControllerTest::onKeyUp, this);
    gameControllerListener->onAxisEvent = AX_CALLBACK_3(GameControllerTest::onAxisEvent, this);
...
void GameControllerTest::onConnectController(ax::Controller *controller, ax::Event *event)
{
...
//    sprintf(deviceInfo,"%s id:%d",controller->getDeviceName().c_str(), controller->getDeviceId());
    ...
    else if(_secondHolder.controller == nullptr)
    {
        ...
        if (_secondHolder._holderNode == nullptr)
        {
            ...
            _firstHolder._holderNode->runAction(MoveTo::create(0.3f,Vec2(_visibleQuarterX, _visibleCenterY)));
            ...
            _secondHolder._holderNode->setPosition(_visibleThreeQuarterX, _visibleCenterY);
    ...
    else
    {
        ...
        if (_firstHolder._holderNode == nullptr)
        {
            ...
            _secondHolder._holderNode->runAction(ScaleTo::create(0.3f,0.5f,0.5f));
            _secondHolder._holderNode->runAction(MoveTo::create(0.3f,Vec2(_visibleQuarterX, _visibleCenterY)));

            _firstHolder._holderNode->setAnchorPoint(Vec2::ANCHOR_MIDDLE);
            _firstHolder._holderNode->setScale(0.1f);
            _firstHolder._holderNode->runAction(ScaleTo::create(0.3f,0.5f,0.5f));
            _firstHolder._holderNode->setPosition(_visibleThreeQuarterX, _visibleCenterY);
...
void GameControllerTest::onDisconnectedController(Controller* controller, Event* event)
{
    ...
    if (_firstHolder.controller == controller)
    {
        ...
        if (_secondHolder.controller != nullptr)
        {
            ...
            _secondHolder._holderNode->runAction(MoveTo::create(0.3f,Vec2(_visibleCenterX,_visibleCenterY) ));
    ...
    else if (_secondHolder.controller == controller)
    {
        ...
        if (_firstHolder.controller != nullptr)
        {
            ...
            _firstHolder._holderNode->runAction(MoveTo::create(0.3f,Vec2(_visibleCenterX,_visibleCenterY) ));
...
bool GameControllerTest::init()
{
    ...
    _visibleCenterX = _visibleOrigin.x + _visibleSize.width / 2;
    _visibleCenterY = _visibleOrigin.y + _visibleSize.height / 2;
